 ...
 * @version 1.0 新規作成
 */
public class CategorySettingActivity extends AbstractBaseActivity implements OnUpdateListener {

    /** ロガー */
    private Logger mLogger = new Logger(CategorySettingActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryListAdapter =
                new ArrayAdapter<String>(
                        CategorySettingActivity.this, android.R.layout.simple_list_item_1, categoryNameList);
    ...
    private class CategoryListOnItemClickListener implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            // カテゴリ編集ダイアログを表示する。
            FragmentManager manager = getSupportFragmentManager();
            CategoryEditDialog categoryEditDialog = CategoryEditDialog.newInstance(mCategoryDataList.get(position));
            categoryEditDialog.show(manager, CategoryEditDialog.class.getSimpleName());
